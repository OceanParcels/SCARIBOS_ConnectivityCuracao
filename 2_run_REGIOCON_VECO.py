...
Release location: VECO = Venezuelan continental coast
...
if __name__ == "__main__":
    ...
    if filenames:
        ...
        runtime = (end_date - start_date).days * 86400  - int(timedelta(days=80).total_seconds()) 
        ...
        pset.execute([AdvectionRK4, FreezeParticle], 
                        runtime=timedelta(days=80),  # instead of total runtime, run VECO for 80 days (check that less than 1% of particles are remaining)
                        dt=ipart_dt, 
                        output_file=outputfile) 
    
        print("*** All good ***, 80 days finished, let's go to the next one!")
