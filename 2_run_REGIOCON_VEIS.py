...
Release location: VEIS = Venezuelan islands
...
if __name__ == "__main__":
    ...
    if filenames:
        ...
        runtime = (end_date - start_date).days * 86400  - int(timedelta(days=65).total_seconds())
        ...
        pset.execute([AdvectionRK4, FreezeParticle], 
                        runtime=timedelta(days=65), # instead of total runtime, run Bonaire for 65 days becuase already checked that way less than 1% of particles remain after 65 days
                        dt=ipart_dt, 
                        output_file=outputfile)
    
        
        print("*** All good ***, 65 days finished, let's go to the next one!")
