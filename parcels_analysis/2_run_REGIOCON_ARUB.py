...
if __name__ == "__main__":
    ...
    if filenames:
        ...
        runtime    = (end_date - start_date).days * 86400  - int(timedelta(days=40).total_seconds())
        ...
        pset.execute([AdvectionRK4, FreezeParticle], 
                        runtime=timedelta(days=40), # instead of total runtime, run Aruba for 40 days becuase already checked that way less than 1% of particles remain after 40 days
                        dt=ipart_dt, 
                        output_file=outputfile)
        
        print("*** All good ***, 40 days finished, let's go to the next one!")
